...
@DisplayName("OrderDTO test(s)")
    ...
    public void getOrderIdTest(){assertEquals("174566d0-767f-11ed-a1eb-0242ac120002",orderDTO.getOrder_id());}

    @Test
    @DisplayName("get user test")
    public void getUserTest(){assertEquals("Diwen Yao",orderDTO.getUser_id());}

    @Test
    @DisplayName("get Restaurant test")
    public void getRestaurantTest(){assertEquals("McDonald",orderDTO.getRestaurant_id());}

    @Test
    @DisplayName("get delivery person test")
    public void getDelivery(){assertEquals("Manil",orderDTO.getDelivery_id());}

    @Test
    @DisplayName("get amount test")
    public void getAmount(){assertEquals(16,orderDTO.getAmount());}

    @Test
    @DisplayName("get status test")
    public void getStatusTest(){assertEquals("Pending",orderDTO.getStatus());}

    @Test
    @DisplayName("get payment option test")
    public void getPaymentTest(){assertEquals("Credit Card",orderDTO.getPayment_options());}

    @Test
    @DisplayName("get date test")
    public void getDateTest(){assertEquals("2022-12-12",orderDTO.getDate());}
